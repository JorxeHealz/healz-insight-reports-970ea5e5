...
export const useDemoBiomarkers = (patientId: string) => {
  return useQuery({
    ...
    queryFn: async (): Promise<Biomarker[]> => {
      ...
      // Mock biomarker definitions with all required BiomarkerRow properties - Updated category to be array
      const availableBiomarkers = [
        { 
          id: '1', name: 'Glucose', unit: 'mg/dL', optimal_min: 70, optimal_max: 100, 
          description: 'Blood glucose level', category: ['Pérdida de Peso', 'Riesgo Cardíaco'], panel: ['Basic Metabolic'],
        ...
        { 
          ...
          description: 'Total cholesterol', category: ['Riesgo Cardíaco', 'Longevidad'], panel: ['Lipid'],
        ...
        { 
          ...
          description: 'Vitamin D 25-OH', category: ['vitalidad', 'Fuerza', 'Longevidad'], panel: ['Vitamins'],
        ...
        { 
          ...
          description: 'Morning cortisol', category: ['hormonas', 'vitalidad', 'Longevidad'], panel: ['Stress'],
        ...
        { 
          ...
          description: 'Thyroid stimulating hormone', category: ['hormonas', 'vitalidad'], panel: ['Thyroid'],
        ...
        { 
          ...
          description: 'C-reactive protein', category: ['Riesgo Cardíaco', 'Longevidad', 'Salud Cerebral'], panel: ['Inflammatory'],
        ...
        { 
          ...
          description: 'Hemoglobin A1c', category: ['Pérdida de Peso', 'Riesgo Cardíaco', 'Longevidad'], panel: ['Diabetes'],
        ...
        { 
          ...
          description: 'Total testosterone', category: ['hormonas', 'vitalidad', 'Salud Sexual', 'Fuerza'], panel: ['Male Hormones'],
        ...
        { 
          ...
          description: 'Estradiol hormone', category: ['hormonas', 'Salud Sexual'], panel: ['Female Hormones'],
        ...
        { 
          ...
          description: 'DHEA sulfate', category: ['hormonas', 'vitalidad'], panel: ['Adrenal'],
        ...
        { 
          ...
          description: 'Follicle stimulating hormone', category: ['hormonas'], panel: ['Female Hormones'],
        ...
        { 
          ...
          description: 'Luteinizing hormone', category: ['hormonas'], panel: ['Female Hormones'],
        ...
        { 
          ...
          description: 'Progesterone hormone', category: ['hormonas', 'Salud Sexual'], panel: ['Female Hormones'],
        ...
        { 
          ...
          description: 'Free thyroxine', category: ['hormonas', 'vitalidad'], panel: ['Thyroid'],
        ...
        { 
          ...
          description: 'Free triiodothyronine', category: ['hormonas', 'vitalidad'], panel: ['Thyroid'],
        ...
        { 
          ...
          description: 'Fasting insulin', category: ['Pérdida de Peso', 'Riesgo Cardíaco'], panel: ['Diabetes'],
        ...
        { 
          ...
          description: 'Iron storage protein', category: ['vitalidad'], panel: ['Iron Studies'],
        ...
        { 
          ...
          description: 'Vitamin B12', category: ['vitalidad', 'Salud Cerebral'], panel: ['Vitamins'],
        ...
        { 
          ...
          description: 'Folic acid', category: ['vitalidad', 'Salud Cerebral'], panel: ['Vitamins'],
        ...
        { 
          ...
          description: 'Serum magnesium', category: ['vitalidad'], panel: ['Electrolytes'],
        ...
        { 
          ...
          description: 'High density lipoprotein', category: ['Riesgo Cardíaco', 'Longevidad'], panel: ['Lipid'],
        ...
        { 
          ...
          description: 'Low density lipoprotein', category: ['Riesgo Cardíaco', 'Longevidad'], panel: ['Lipid'],
        ...
        { 
          ...
          description: 'Blood triglycerides', category: ['Riesgo Cardíaco', 'Pérdida de Peso'], panel: ['Lipid'],
        ...
        { 
          ...
          description: 'Cardiovascular risk marker', category: ['Riesgo Cardíaco', 'Salud Cerebral'], panel: ['Cardiac Risk'],
        ...
        { 
          ...
          description: 'Serum iron', category: ['vitalidad'], panel: ['Iron Studies'],
