      ...
      <CardContent className="p-6 space-y-6">
        ...
        <div className="bg-healz-cream/30 rounded-lg p-5">
          ...
          <div className="prose prose-sm max-w-none">
            {diagnosis && diagnosis.trim() !== '' && diagnosis !== 'No se ha generado un diagnóstico para este reporte.' ? <div className="text-healz-brown leading-relaxed whitespace-pre-wrap text-base space-y-3">
